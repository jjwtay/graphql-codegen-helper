import { DirectiveNode, ArgumentNode, ValueNode, ObjectFieldNode } from 'graphql'
...
export const convertArray = R.reduce(
    (acc, directive: DirectiveNode): { [key: string]: object } =>
        R.assoc(directive.name.value, convertDirective(directive), acc),
    {}
)
